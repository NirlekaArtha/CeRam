...
<body class="bg-background text-white font-inter overflow-x-hidden flex w-screen h-screen">
  ...
  <main class="py-16 px-4 sm:px-20 flex-1 w-screen h-screen">
    <div class="flex w-full justify-start">
      <img src="../../pictures/profil-ceram.jpg" alt="profile-pict" 
      ...
      <div class="flex flex-col gap-4 justify-center ml-4">
        ...
        <button type="button" class="cursor-pointer flex justify-center items-center gap-2 w-24 py-2 border rounded-md text-accent1 border-accent1">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" 
            stroke-linecap="round" stroke-linejoin="round">
      ...
      <form action="">
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-16">
          ...
          <div class="flex flex-col gap-1">
            ...
            <input type="text" name="username" id="username" placeholder="Username" value="Nirleka_arthamevira"
            ...
            <input type="text" name="Email" id="Email" placeholder="Email" value="nirlekaarthamevira@gmail.com"
